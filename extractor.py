...
# class Efffeature(SubModule):
#     def __init__(self):
#         super(Efffeature, self).__init__()
#         pretrained = True
...
# class EFeature(SubModule):
#     def __init__(self):
#         super(EFeature, self).__init__()
#         pretrained =  True
#         # pretrained_cfg_overlay = {'file' : r"/root/.cache/huggingface/hub/ghostnetv2_100/pytorch_model.bin"}
          # timm = 0.6.7
#         model = timm.create_model('tf_efficientnet_b0', pretrained=pretrained, features_only=True)

#         layers = [1,2,3,5,6]
#         #chans = [16, 24, 32, 96, 160]
#         chans = [16, 24, 40, 112, 192]
#         self.conv_stem = model.conv_stem
#         self.bn1 = model.bn1
#         #self.act1 = model.act1
